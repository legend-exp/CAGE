...
with open('icpc_dsp.json') as f: dsp_config = json.load(f, object_pairs_hook=OrderedDict)
with open('icpc_apdb.json') as f: apdb = json.load(f, object_pairs_hook=OrderedDict)
